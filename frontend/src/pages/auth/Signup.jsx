  ...
  return (
    <>
      <div className="w-full bg-gradient-to-r from-[#000106] via-[#282f51] to-[#000106] h-screen pt-20 flex items-center justify-center">
        <div className="w-2/7 bg-gradient-to-r from-[rgba(0,3,10,1)] via-[#1b1a1a] to-[rgba(0,3,10,1)] h-9/10 flex justify-start items-center flex-col p-7 gap-1 rounded-xl text-white">
          <div className="flex flex-col justify-center text-center items-center">
            <h1>Sign UP</h1>
          </div>
          <form
            className="flex flex-col w-full gap-3 p-5 text-white"
