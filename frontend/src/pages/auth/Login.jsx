  ...
  return (
    <>
      <div className="w-full bg-gradient-to-r from-[#000106] via-[#282f51] to-[#000106] h-screen pt-20 flex items-center justify-center">
        <div className="w-2/7 bg-gradient-to-r from-[rgba(0,3,10,1)] via-[#1b1a1a] to-[rgba(0,3,10,1)] h-4/5 flex justify-start items-center flex-col p-7 gap-2 rounded-xl text-white">
